...
## Before going live
- [ ] **Favicon**: `favicon.svg` is in place. Add **apple-touch-icon.png** (180×180) in repo root for “Add to Home Screen”.
- [ ] **Social image**: Add **img/og.png** (1200×630) — export from `img/og.svg` — so link previews show the branded card.
- [ ] **Canonical / OG URL**: Already set to `https://didtheydeliver.co.uk`; change if you use a different domain.
- [ ] **robots.txt** and **sitemap.xml** are in place; submit sitemap in Google Search Console after launch.
- [ ] **HTTPS**: Ensure GitHub Pages (or your host) serves the site over HTTPS.
